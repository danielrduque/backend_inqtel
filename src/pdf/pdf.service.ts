...
export class PdfService {
  async generarFacturaPDF(data: {
    ...
    const facturasDir = join(__dirname, '../../public/facturas');
    ...
    if (fs.existsSync(logoPath)) {
      doc.image(logoPath, pageMargin, currentY, { width: 70 });
    } else {
      doc
        .fontSize(18)
    ...
    doc
      ...
      .text('No somos Agente Retenedor de IVA', pageMargin + 80, currentY + 36)
      .text(
    ...
    doc
      ...
      .text(`Fecha de Emisión: ${data.fecha}`, invoiceDetailsX, currentY + 31, {
        width: 220,
        align: 'right',
      })
      .text(
    ...
    const drawInfoBlock = (
      ...
      details.forEach((detail, index) => {
        ...
        doc
          ...
          .text(detail.value, xPos + 85, yPos + 5, { width: blockWidth - 90 });
    ...
    const emisorDetails = [
      { label: 'Razón Social:', value: 'IN QUALITY TELECOMUNICATIONS S.A.S.' },
    ...
    const clienteDetails = [
      ...
      { label: 'Teléfono:', value: data.cliente.telefono || 'No especificado' },
    ...
    doc
      ...
      .fontSize(smallFontSize)
      .fillColor(textColor)
      .text('Pagos en: Calle 3 #9-64 Pablo VI Mocoa', pageMargin + 5, currentY)
      .text(
